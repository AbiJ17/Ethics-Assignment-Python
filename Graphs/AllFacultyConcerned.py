...
def allFacultyConcerned():
    ...
    x_science = science_df['On a scale of 1-5, are you concerned that the use of ChatGPT for academic purposes may promote academic dishonesty or cheating?']
    ...
    x_engineering = engineering_df['On a scale of 1-5, are you concerned that the use of ChatGPT for academic purposes may promote academic dishonesty or cheating?']
    ...
    x_business = business_df['On a scale of 1-5, are you concerned that the use of ChatGPT for academic purposes may promote academic dishonesty or cheating?']
    ...
    x_medicine = medicine_df['On a scale of 1-5, are you concerned that the use of ChatGPT for academic purposes may promote academic dishonesty or cheating?']
    ...
    for i, v in enumerate(y_engineering.values):
        plt.text(i + 1.16, v + 0.5, str(v), color='black', fontweight='bold')
    ...
    plt.title('Concern that ChatGPT Promotes Academic Dishonesty/Cheating (All Faculties)')
