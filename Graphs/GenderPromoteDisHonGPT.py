...
def genADGPT():
    ...
    x_male = male_df['On a scale of 1-5, are you concerned that the use of ChatGPT for academic purposes may promote academic dishonesty or cheating?']
    ...
    x_female = female_df['On a scale of 1-5, are you concerned that the use of ChatGPT for academic purposes may promote academic dishonesty or cheating?']
    ...
    x_other = other_df['On a scale of 1-5, are you concerned that the use of ChatGPT for academic purposes may promote academic dishonesty or cheating?']
    ...
    plt.title('Concerns About ChatGPT Promoting Academic Dishonesty (Genders)')
