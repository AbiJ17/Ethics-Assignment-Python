...
def genAccurateGPT():
    ...
    x_male = male_df['On a scale of 1-5, how accurate is the information/answers provided by ChatGPT?']
    ...
    x_female = female_df['On a scale of 1-5, how accurate is the information/answers provided by ChatGPT?']
    ...
    x_other = other_df['On a scale of 1-5, how accurate is the information/answers provided by ChatGPT?']
    ...
    plt.title('Accuracy of Information/Answers by ChatGPT (Genders)')
